...
Pod::Spec.new do |s|
  s.name             = 'LCXDemoMenu'
  s.version          = '0.1.0'
  s.summary          = 'A short description of LCXDemoMenu.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/475512103@qq.com/LCXDemoMenu'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '475512103@qq.com' => 'leichunxiang58@163.com' }
  s.source           = { :git => 'https://github.com/475512103@qq.com/LCXDemoMenu.git', :tag => s.version.to_s }
